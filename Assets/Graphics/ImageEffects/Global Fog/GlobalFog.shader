...
CGINCLUDE
	...
	half4 ComputeFog (v2f i, bool distance, bool height) : SV_Target
	{
		...
		//if (i.interpolatedRay.y>2000) return sceneColor;
		//if (dot(wsDir.xz,wsDir.xz)>10000 && wsPos.y<2000) return unity_FogColor;
		//else return sceneColor;
		if (dpth==1) return sceneColor;
